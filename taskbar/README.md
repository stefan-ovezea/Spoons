...
Taskbar is an early Hammerspoon Spoon that experiments with a lightweight macOS taskbar replacement. The first milestone is intentionally small: one `hs.canvas` bar per monitor, running and pinned apps displayed as icons, and launch-or-focus behavior.
